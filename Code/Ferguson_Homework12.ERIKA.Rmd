...
```
You could do lines 51 though 60 more efficiently without creating plt1 as follows:
...
```
Again, you can use filter to isolate just the data you want so that you don't have to do two steps. See if you can adjust your code accordingly.
