...
summary(model_zinc)
```
The results of the ANOVA show that there is a significant difference in zinc abundance between the Degrasse location and the others.  Between the rest of the forests, there is no significant difference in zinc soil abundance
